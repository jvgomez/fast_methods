/*! \file console.h
    \brief Header of the console class
    
   A stand-alone, standard C++ functions encapsulated in an static class
   which helps to deal with the console
   input/output by displaying predefined message styles or parsing options.
